...
/*
             ...
             ┃ CTR │  ⌘  │  ↑  │ SFT │     ┃      ┃     │ SFT │  ↑  │  ⌘  │ CTR ┃
             ┠─────┼─────┼─────┼─────┼─────┫      ┠─────┼─────┼─────┼─────┼─────┫
             ┃ TAB │  q  │j|alt│  k  │  x  ┃      ┃  b  │  m  │w|alt│  v  │  z  ┃
             ┗━━━━━┷━━━━━┼─────┼─────┼─────┫      ┠─────┼─────┼─────╆━━━━━┷━━━━━┛
                         ┃     │ BSP │  #  ┃      ┃ E   │ _|$ │  ✪  ┃
                         ┗━━━━━┷━━━━━┷━━━━━┛      ┗━━━━━┷━━━━━┷━━━━━┛
*/
        KC_NO,        KC_NO,        KC_ESC,         KC_P,         KC_Y,                       KC_F,               KC_G,                   KC_C,            KC_R,            KC_L,
        LCTL_T(KC_A), LGUI_T(KC_O), LT(_NAV, KC_E), LSFT_T(KC_U), KC_I,                       KC_D,               RSFT_T(KC_H),           LT(_NAV, KC_T),  RGUI_T(KC_N),    RCTL_T(KC_S),
        KC_TAB,       KC_Q,         LALT_T(KC_J),   KC_K,         KC_X,                       KC_B,               KC_M,                   RALT_T(KC_W),    KC_V,            KC_Z,
        KC_NO,        KC_NO,         KC_DELETE,     KC_BSPC,      MO(_NUMPAD),                KC_ENTER,           LT(_SYMBOLS, KC_SPACE), MO(_SPACES),     KC_NO,           KC_NO
    ),
    [_NAV] = LAYOUT(
/*
             ┏━━━━━┯━━━━━┯━━━━━┯━━━━━┯━━━━━┓      ┏━━━━━┯━━━━━┯━━━━━┯━━━━━┯━━━━━┓
...
*/
      ...
      KC_NO,    KC_NO,    KC_NO, KC_LSFT, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO
    ),
    [_SYMBOLS] = LAYOUT(
/*
             ┏━━━━━┯━━━━━┯━━━━━┯━━━━━┯━━━━━┓      ┏━━━━━┯━━━━━┯━━━━━┯━━━━━┯━━━━━┓
...
*/
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO
    )
};
